import{F as R,_,G as C,H as x,I as ue,J as j,K as Ue,L as g,M as Ve,N as Ge,O as We,Q as Je,R as E}from"./firestoreService-bw3W79Dy.js";import"./logo-BJJW74Um.js";const de="@firebase/installations",L="0.6.22";/**
 * @license
 ...
 */const fe=1e4,le=`w:${L}`,pe="FIS_v2",ze="https://firebaseinstallations.googleapis.com/v1",Qe=3600*1e3,Ye="installations",Xe="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function U(e,t=!1){let n;const i=await N(e.appConfig,o=>{if(!Re(o))throw w.create("not-registered");const a=o.authToken;if(!t&&St(a))return o;if(a.requestStatus===1)return n=It(e,t),o;{if(!navigator.onLine)throw w.create("app-offline");const u=vt(o);return n=mt(e,u),u}});return n?await n:i.authToken}async function It(e,t){let n=await Q(e.appConfig);for(;n.authToken.requestStatus===1;)await Ie(100),n=await Q(e.appConfig);const i=n.authToken;return i.requestStatus===0?U(e,t):i}function Q(e){return N(e,t=>{if(!Re(t))throw w.create("not-registered");const n=t.authToken;return At(n)?{...t,authToken:{requestStatus:0}}:t})}async function mt(e,t){try{const n=await yt(e,t),i={...t,authToken:n};return await D(e.appConfig,i),n}catch(n){if(ge(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await Ae(e.appConfig);else{const i={...t,authToken:{requestStatus:0}};await D(e.appConfig,i)}throw n}}function Re(e){return e!==void 0&&e.registrationStatus===2}function St(e){return e.requestStatus===2&&!kt(e)}function kt(e){const t=Date.now();return t<e.creationTime||e.creationTime+e.expiresIn<t+Qe}function vt(e){const t={requestStatus:1,requestTime:Date.now()};return{...e,authToken:t}}function At(e){return e.requestStatus===1&&e.requestTime+fe<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _e="installations",Nt="installations-internal",Ot=e=>{const t=e.getProvider("app").getImmediate(),n=Dt(t),i=x(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:i,_delete:()=>Promise.resolve()}},Mt=e=>{const t=e.getProvider("app").getImmediate(),n=x(t,_e).getImmediate();return{getId:()=>Et(n),getToken:r=>Rt(n,r)}};function Ft(){_(new C(_e,Ot,"PUBLIC")),_(new C(Nt,Mt,"PRIVATE"))}Ft();R(de,L);R(de,L,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pt="/firebase-messaging-sw.js",Kt="/firebase-cloud-messaging-push-scope",Ce="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",$t="https://fcmregistrations.googleapis.com/v1",De="google.c.a.c_id",Ht="google.c.a.c_l",xt="google.c.a.ts",jt="google.c.a.e",Y=1e4;var X;(function(e){e[e.DATA_MESSAGE=1]="DATA_MESSAGE",e[e.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(X||(X={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ee="firebase-messaging-database",te=2,p="firebase-messaging-store",l="firebase-messaging-fid-registration-store",Vt={openDB:j,deleteDB:E};let ne=Vt,k=null;function Gt(e,t,n){switch(t){case 0:if(e.createObjectStore(p),n===1)break;case 1:n===2&&e.createObjectStore(l)}}function ie(e){return{upgrade:(t,n)=>{Gt(t,n,e)},blocked:()=>{},blocking:(t,n,i)=>{var r;k=null,(r=i.target)==null||r.close()},terminated:()=>{k=null}}}function m(){return k||(k=ne.openDB(ee,te,ie(2)).catch(()=>ne.openDB(ee,te-1,ie(1)))),k}function Oe(e,t){return e.objectStoreNames.contains(t)}function V(e){if(!Oe(e,l))throw c.create("fid-registration-idb-schema-unavailable")}async function Me(e){const t=S(e),i=await(await m()).transaction(p).objectStore(p).get(t);if(i)return i;{const r=await qt(e.appConfig.senderId);if(r)return await G(e,r),r}}async function G(e,t){const n=S(e),i=await m(),r=[p],o=Oe(i,l);o&&r.push(l);const a=i.transaction(r,"readwrite");return await a.objectStore(p).put(t,n),o&&await a.objectStore(l).delete(n),await a.done,t}async function Fe(e){const t=S(e),i=(await m()).transaction(p,"readwrite");await i.objectStore(p).delete(t),await i.done}async function O(e){const t=S(e),n=await m();return V(n),await n.transaction(l).objectStore(l).get(t)}async function Wt(e,t){const n=S(e),i=await m();V(i);const r=i.transaction([p,l],"readwrite");return await r.objectStore(l).put(t,n),await r.objectStore(p).delete(n),await r.done,t}async function Pe(e){const t=S(e),n=await m();V(n);const i=n.transaction(l,"readwrite");await i.objectStore(l).delete(t),await i.done}function S({appConfig:e}){return e.appId}const re="@firebase/messaging",H="0.13.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xe(e){try{e.swRegistration=await navigator.serviceWorker.register(Pt,{scope:Kt}),e.swRegistration.update().catch(()=>{}),await gn(e.swRegistration)}catch(t){throw c.create("failed-service-worker-registration",{browserErrorMessage:t==null?void 0:t.message})}}async function gn(e){return new Promise((t,n)=>{const i=setTimeout(()=>n(new Error(`Service worker not registered after ${Y} ms`)),Y),r=e.installing||e.waiting;e.active?(clearTimeout(i),t()):r?r.onstatechange=o=>{var a;((a=o.target)==null?void 0:a.state)==="activated"&&(r.onstatechange=null,clearTimeout(i),t())}:(clearTimeout(i),n(new Error("No incoming service worker found.")))})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function je(e,t){if(!t&&!e.swRegistration&&await xe(e),!(!t&&e.swRegistration)){if(!(t instanceof ServiceWorkerRegistration))throw c.create("invalid-sw-registration");e.swRegistration=t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const se=3;async function hn(e,t){const n=await wn(e.swRegistration,e.vapidKey),i={vapidKey:e.vapidKey,swScope:e.swRegistration.scope,endpoint:n.endpoint,auth:f(n.getKey("auth")),p256dh:f(n.getKey("p256dh"))},r=e.firebaseDependencies.installations;for(let o=0;o<se;o++){const{responseFid:a}=await Yt(e.firebaseDependencies,i);if(a===t)return;o<se-1&&await r.getToken(!0)}throw c.create("fid-registration-failed",{errorInfo:"CreateRegistration response FID does not match Firebase Installation ID"})}async function wn(e,t){const n=await e.pushManager.getSubscription();return n||e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:Ne(t)})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function An(e,t,n){const i=En(t);(await e.firebaseDependencies.analyticsProvider.get()).logEvent(i,{message_id:n[De],message_name:n[Ht],message_time:n[xt],message_device_time:Math.floor(Date.now()/1e3)})}function En(e){switch(e){case T.NOTIFICATION_CLICKED:return"notification_open";case T.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Nn(){try{await Ge()}catch{return!1}return typeof window<"u"&&We()&&Je()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function On(e){if(!navigator)throw c.create("only-available-in-window");return e.swRegistration||await xe(e),cn(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xn(e=Ve()){return Nn().then(t=>{if(!t)throw c.create("unsupported-browser")},t=>{throw c.create("indexed-db-unsupported")}),x(g(e),"messaging").getImmediate()}async function jn(e,t){return e=g(e),qe(e,t)}function Ln(e){return e=g(e),On(e)}function qn(e,t){return e=g(e),Mn(e,t)}async function Bn(e,t){return e=g(e),J(e,t)}async function Un(e){return e=g(e),Kn(e)}function Vn(e,t){return e=g(e),Fn(e,t)}function Gn(e,t){return e=g(e),Pn(e,t)}Dn();export{Ln as deleteToken,xn as getMessaging,jn as getToken,Nn as isSupported,qn as onMessage,Vn as onRegistered,Gn as onUnregistered,Bn as register,Un as unregister};
